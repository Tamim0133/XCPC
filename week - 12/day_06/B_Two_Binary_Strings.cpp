...
void dusty()
{
    ...
    int first_0 = arr.size();
    int last_0 = -1;
    int first_1 = arr.size();
    int last_1 = -1;
    // debug(minus);
    for (int i = 0; i < arr.size(); i++)
    {
    ...
    for (auto i : minus)
    {
        if (first_0 < arr.size() and last_0 > -1 and i > first_0 and i < last_0)
        {
            // i = -1;
        }
        // else if (first_1 < arr.size() and last_1 > -1 and i > first_1 and i < last_1)
        // {
        //     // i = -1;
        // }
        else
    ...
    for (auto i : minus)
    {
        ...
        //     // i = -1;
        // }
        if (first_1 < arr.size() and last_1 > -1 and i > first_1 and i < last_1)
        {
            // i = -1;
        }
        else
    ...
    for (auto i : minus)
    {
        if (last_0 < first_1 or last_1 < first_0)
        {
            if (first_0 < arr.size() and last_0 > -1 and i > first_0 and i < last_0)
            {
                // i = -1;
